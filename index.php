...
$testimonials = [
    ...
    ['quote' => 'Selalu puas dengan Soncake. Varian kuenya banyak dan semuanya lezat.', 'author' => 'Citra D.'], // Diubah di sini
];
...
<head>
    ...
    <title>Selamat Datang di Soncake</title> <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
...
<body>
    ...
    <header class="main-header">
        <div class="container header-content">
            <div class="logo">
                <a href="index.php">Soncake</a> </div>
            <nav class="main-nav">
                <ul>
    ...
    <main>
        <section class="hero-section">
            <div class="container">
                ...
                <p>Dari ulang tahun hingga pernikahan, Soncake sajikan kebahagiaan dalam setiap gigitan.</p> <a href="katalogawal.php" class="btn-primary">Lihat Koleksi Kue</a>
            </div>
        </section>
    ...
    <footer class="main-footer">
        <div class="container footer-content">
            <div class="footer-section about">
                <h3>Tentang Soncake</h3> <p>Kami menyajikan kue-kue premium dengan bahan terbaik untuk setiap momen spesial Anda.</p>
            </div>
            ...
            <div class="footer-section contact">
                ...
                <p><i class="fas fa-envelope"></i> info@soncake.com</p> </div>
